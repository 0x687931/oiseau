...
+==========================================================+
|                                                          |
|  Clone and source in your script - no dependencies       |
|  required!                                               |
|                                                          |
|  To resolve:                                             |
...
+==========================================================+
|                                                          |
|  Minimum: Bash 3.2+ (macOS compatible). Recommended:     |
|  Bash 4.0+ for best performance and UTF-8 terminal for   |
|  rich mode.                                              |
|                                                          |
+==========================================================+
